...
class SlideSidebar(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        # 按钮显示/隐藏动画（透明度）
        self._button_opacity_anim = QPropertyAnimation(self._toggle_btn, b"windowOpacity", self)
    ...
    def _set_sidebar_width(self, value: int) -> None:
        self._sidebar_width = max(self._button_width, min(value, self._button_width + self._expanded_width))
        self._update_layout()
