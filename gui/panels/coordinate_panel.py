...
from PySide6.QtWidgets import (
    QWidget, QGroupBox, QFormLayout, QLineEdit, QDoubleSpinBox,
    QComboBox, QPushButton, QHBoxLayout, QSpinBox, QLabel,
...
class CoordinateSystemPanel(QGroupBox):
    ...
    def _init_ui(self):
        ...
        # 连接值变化信号
        for widget in [self.cref_input, self.bref_input, self.sref_input, self.q_input]:
