    ...
    def setup_ui(self):
        ...
        try:
            ...
            try:
                ...
                # 连接带状态类型的信号
                state_banner.exitStateRequested.connect(
                    self._on_banner_exit_state_requested
                )
    ...
    def _on_banner_exit_requested(self):
        ...
        try:
            ...
            if banner:
                ...
                state_type = getattr(
                    banner, "_current_state_type", BannerStateType.NONE
                )
    ...
    def _on_banner_exit_state_requested(self, state_type):
        ...
        try:
            ...
            if state_type == BannerStateType.REDO_MODE:
                ...
                try:
                    if (
                        hasattr(self.main_window, "batch_manager")
                        and self.main_window.batch_manager
                    ):
