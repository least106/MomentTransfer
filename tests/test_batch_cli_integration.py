...
""")
    ...
    run_batch_processing_v2(config_path='data/input.json', input_path=str(tmp_path), data_config=cfg, registry_db=str(registry_db), strict=False, dry_run=False, show_progress=False, output_json=str(out_json), summary=True)
