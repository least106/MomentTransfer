from src.models.project_model import ProjectConfigModel, Part, PartVariant, CoordinateSystem, ReferenceValues
...
def test_on_source_part_changed_applies_payload():
    ...
    pv = PartVariant(part_name='P', coord_system=CoordinateSystem(), refs=ReferenceValues())
