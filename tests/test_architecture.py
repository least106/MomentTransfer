...
from src.config import SystemConfig, CacheConfig, BatchProcessConfig, get_config, set_config, reset_config
from src.cache import (
    CalculationCache, RotationMatrixCache, TransformationCache,
    CacheKey, get_rotation_cache, get_transformation_cache, clear_all_caches
)
from src.plugin import (
    PluginRegistry, PluginLoader, CoordSystemPlugin, PluginMetadata,
    BasePlugin, get_plugin_registry
)
        ...
        class TestPlugin(CoordSystemPlugin):
            ...
            def metadata(self) -> PluginMetadata:
                return PluginMetadata(
                    ...
                    description='Test', plugin_type='coord_system'
                )
            def get_coordinate_system(self, name: str): return None
            def list_coordinate_systems(self) -> List[str]: return []
